...
1. 设计API的变动，必须重新修改 API.md 文件
2. 每次版本迭代，都必须在 CHANGELOG.md 说明版本更新内容
3. 涉及到代码重构，必须在对应的前端或后端的文件夹下的 REFACTOR.md 说明 重构计划和实现效果
4. 对于执行过程中所用到的临时脚本，应当创建一个文件夹 scripts 储存，并且不再使用的情况下必须删除
