...
一个全栈文件管理应用，支持文件浏览、上传、下载、压缩、系统监控，并通过插件系统扩展功能（SMB 共享、主题等）。提供 Web 界面和 Electron 桌面应用两种使用方式。

## 在线预览

体验纯前端 Demo（无后端服务，文件数据为内存模拟、刷新即重置）：

<https://mqnu00.github.io/file-manager/>
...
| [hatsune-miku-theme](./plugins/hatsune-miku-theme)                                                | 初音未来青绿霓虹主题（npm 包 `@mqn00/file-manager-plugin-hatsune-miku-theme`） |
