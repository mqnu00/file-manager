...
html.hatsune-miku {
  ...
  /* \u9762\u677F\u590D\u523B\u80CC\u666F\uFF08\u4E3B\u9879\u76EE\u60AC\u6D6E\u9762\u677F\u94A9\u5B50\uFF0C\u5982\u8BBE\u7F6E\u9875\u5438\u5E95\u64CD\u4F5C\u680F\uFF09\uFF1A\u4E0E el-dialog /
     el-select \u4E0B\u62C9\u540C\u4E00\u5957\u300C\u6697\u8272\u53E0\u52A0 + \u80CC\u666F\u56FE\u300D\u914D\u65B9\u3002\u6CE8\u610F\uFF1A\u4E0D\u80FD\u7528
     background-attachment: fixed \u2014\u2014 \u9762\u677F\u4F4D\u4E8E\u5E26 backdrop-filter \u7684\u5361\u7247\u5185\uFF0C
     Chromium \u4F1A\u628A fixed \u80CC\u666F\u76F8\u5BF9\u8BE5\u7956\u5148\u5B9A\u4F4D\uFF08\u751A\u81F3\u4E0D\u7ED8\u5236\uFF09\uFF0C\u5BFC\u81F4\u900F\u51FA\u5E95\u4E0B\u5185\u5BB9\u3002
     \u8FD9\u91CC CSS \u53EA\u63D0\u4F9B\u4E0D\u900F\u660E\u57FA\u7EBF\uFF08\u5143\u7D20\u5750\u6807\u5BF9\u9F50\uFF0C\u672A\u6821\u51C6\u4F46\u76D6\u5F97\u4F4F\uFF09\uFF0C
     \u7CBE\u786E\u7684\u89C6\u53E3\u5BF9\u4F4D\u7531 panel-replica.ts \u6309\u9762\u677F\u5B9E\u65F6\u89C6\u53E3\u4F4D\u7F6E\u8BA1\u7B97\u5199\u5165\u3002 */
  --app-panel-replica: linear-gradient(var(--app-panel), var(--app-panel)) 0 0 / auto no-repeat,
    linear-gradient(rgb(4 4 5 / 45%), rgb(4 4 5 / 45%)) 0 0 / auto no-repeat,
    radial-gradient(1000px 520px at 15% -5%, rgb(0 242 255 / 12%), transparent 65%) 0 0 / 100vw 100vh no-repeat,
    var(--miku-bg) center / cover no-repeat var(--app-bg);
...
function coverRect(vw, vh, iw, ih) {
...
function recompute() {
  ...
  for (const el of Array.from(document.querySelectorAll("[data-panel-replica]"))) {
    const rect = el.getBoundingClientRect();
